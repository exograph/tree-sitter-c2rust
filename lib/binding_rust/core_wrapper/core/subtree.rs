...
type C2RustUnnamed_5 = crate::core_transpiled::util::ScannerStateWithLookahead;
type C2RustUnnamed_6 = crate::core_transpiled::util::ScannerStateLookaheadMeta;
type C2RustUnnamed_7 = crate::core_transpiled::util::ScannerStateLookaheadFirstLeaf;
#[derive(Copy, Clone)]
#[repr(C)]
pub union Subtree {
...
type C2RustUnnamed_8 = crate::core_transpiled::util::StackElement<*mut EditEntry>;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub unsafe extern "C" fn ts_external_scanner_state_init(
    ...
    if length as libc::c_ulong > ::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong {
        (*self_0).c2rust_unnamed.long_data =
            crate::core_transpiled::alloc::ts_malloc(length as size_t) as *mut libc::c_char;
...
pub unsafe extern "C" fn ts_external_scanner_state_copy(
        ...
        > ::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong
    {
        result.c2rust_unnamed.long_data =
            crate::core_transpiled::alloc::ts_malloc((*self_0).length as size_t)
                as *mut libc::c_char;
        std::ptr::copy_nonoverlapping(
...
pub unsafe extern "C" fn ts_subtree_array_copy(
    ...
    if self_0.capacity > 0 as libc::c_int as libc::c_uint {
        (*dest).contents = crate::core_transpiled::alloc::ts_calloc(
...
unsafe extern "C" fn ts_subtree_pool_allocate(
    ...
    if (*self_0).free_trees.size > 0 as libc::c_int as libc::c_uint {
        ...
        return crate::core_transpiled::alloc::ts_malloc(
...
unsafe extern "C" fn ts_subtree_pool_free(
            ...
            <= 32 as libc::c_int as libc::c_uint
    {
        ...
        *((*self_0).free_trees.contents).offset(fresh5 as isize) = MutableSubtree { ptr: tree };
        ...
        crate::core_transpiled::alloc::ts_free(tree as *mut libc::c_void);
    };
}
#[inline]
unsafe extern "C" fn ts_subtree_can_inline(
    ...
    return padding.bytes < 255 as libc::c_int as libc::c_uint
        ...
        && size.bytes < 255 as libc::c_int as libc::c_uint
...
pub unsafe extern "C" fn ts_subtree_clone(mut self_0: Subtree) -> MutableSubtree {
    ...
    let mut new_children: *mut Subtree =
        crate::core_transpiled::alloc::ts_malloc(alloc_size) as *mut Subtree;
...
pub unsafe extern "C" fn ts_subtree_new_node(
    ...
    if ((*children).capacity as libc::c_ulong)
        ...
        < new_byte_size
    {
        (*children).contents = crate::core_transpiled::alloc::ts_realloc(
...
pub unsafe extern "C" fn ts_subtree_new_missing_leaf(
    ...
    if (result.data).is_inline() {
        ...
        let ref mut fresh7 = *(result.ptr as *mut SubtreeHeapData);
        (*fresh7).set_is_missing(1 as libc::c_int != 0);
    }
    return result;
}
#[no_mangle]
...
pub unsafe extern "C" fn ts_subtree_release(mut pool: *mut SubtreePool, mut self_0: Subtree) {
        ...
        == 0 as libc::c_int as libc::c_uint
    {
        ...
        *((*pool).tree_stack.contents).offset(fresh8 as isize) = ts_subtree_to_mut_unsafe(self_0);
    }
            ...
            while i < (*tree.ptr).child_count {
                ...
                if !(child.data).is_inline() {
                        ...
                        == 0 as libc::c_int as libc::c_uint
                    {
                        ...
                        let fresh9 = (*pool).tree_stack.size;
                        (*pool).tree_stack.size = ((*pool).tree_stack.size).wrapping_add(1);
                        *((*pool).tree_stack.contents).offset(fresh9 as isize) =
                            ts_subtree_to_mut_unsafe(child);
                    }
                }
                i = i.wrapping_add(1);
            }
            crate::core_transpiled::alloc::ts_free(children as *mut libc::c_void);
        } else {
...
pub unsafe extern "C" fn ts_subtree_compare(
    ...
    (*pool).tree_stack.size = ((*pool).tree_stack.size).wrapping_add(1);
    *((*pool).tree_stack.contents).offset(fresh10 as isize) = ts_subtree_to_mut_unsafe(left);
    _array__grow(
        &mut (*pool).tree_stack as *mut MutableSubtreeArray as *mut Array,
        1 as libc::c_int as uint32_t,
        ::core::mem::size_of::<MutableSubtree>() as libc::c_ulong,
    ...
    (*pool).tree_stack.size = ((*pool).tree_stack.size).wrapping_add(1);
    *((*pool).tree_stack.contents).offset(fresh11 as isize) = ts_subtree_to_mut_unsafe(right);
    while (*pool).tree_stack.size > 0 as libc::c_int as libc::c_uint {
        (*pool).tree_stack.size = ((*pool).tree_stack.size).wrapping_sub(1);
        ...
        while i > 0 as libc::c_int as libc::c_uint {
            ...
            (*pool).tree_stack.size = ((*pool).tree_stack.size).wrapping_add(1);
            *((*pool).tree_stack.contents).offset(fresh12 as isize) =
            ...
            (*pool).tree_stack.size = ((*pool).tree_stack.size).wrapping_add(1);
            *((*pool).tree_stack.contents).offset(fresh13 as isize) =
...
pub unsafe extern "C" fn ts_subtree_edit(
    ...
    let fresh14 = stack.size;
    stack.size = (stack.size).wrapping_add(1);
    *(stack.contents).offset(fresh14 as isize) = {
    ...
    while stack.size != 0 {
        ...
        let mut parent_depends_on_column: bool = ts_subtree_depends_on_column(*entry.tree);
        let mut column_shifted: bool = edit.new_end.extent.column != edit.old_end.extent.column;
        ...
        *entry.tree = ts_subtree_from_mut(result);
        ...
        while i < n {
                ...
                < edit.start.bytes)
            {
                ...
                let fresh15 = stack.size;
                stack.size = (stack.size).wrapping_add(1);
                *(stack.contents).offset(fresh15 as isize) = {
                    let mut init = EditEntry {
                        tree: child,
                        edit: child_edit,
                    };
...
pub unsafe extern "C" fn ts_subtree_string(
    ...
    let mut result: *mut libc::c_char = crate::core_transpiled::alloc::ts_malloc(
...
pub unsafe extern "C" fn ts_subtree__print_dot_graph(
    ...
    if ts_subtree_has_changes(*self_0) {
        fwrite!(f, ", color=green, penwidth=2",).unwrap_or(usize::MAX) as os::raw::c_int;
    }
