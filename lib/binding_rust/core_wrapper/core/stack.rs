...
type C2RustUnnamed_3 = crate::core_transpiled::util::LongShortData;
type C2RustUnnamed_4 = crate::core_transpiled::util::ScannerStateWithLookahead;
...
type C2RustUnnamed_7 = crate::core_transpiled::util::StackElement<*mut StackIterator>;
#[derive(Copy, Clone)]
#[repr(C)]
...
type C2RustUnnamed_8 = crate::core_transpiled::util::StackElement<*mut StackHead>;
#[derive(Copy, Clone)]
#[repr(C)]
...
type C2RustUnnamed_9 = crate::core_transpiled::util::StackElement<*mut *mut StackNode>;
...
unsafe extern "C" fn stack_node_new(
    ...
    let mut node: *mut StackNode = (if (*pool).size > 0 as libc::c_int as libc::c_uint {
        ...
        *((*pool).contents).offset((*pool).size as isize) as *mut libc::c_void
        ...
        crate::core_transpiled::alloc::ts_malloc(
            ::core::mem::size_of::<StackNode>() as libc::c_ulong
        )
    }) as *mut StackNode;
    *node = {
...
unsafe extern "C" fn stack_head_delete(
    ...
    if !((*self_0).node).is_null() {
        ...
        if !((*self_0).summary).is_null() {
            ...
            crate::core_transpiled::alloc::ts_free((*self_0).summary as *mut libc::c_void);
        }
...
pub unsafe extern "C" fn ts_stack_new(mut subtree_pool: *mut SubtreePool) -> *mut Stack {
    let mut self_0: *mut Stack = crate::core_transpiled::alloc::ts_calloc(
...
pub unsafe extern "C" fn ts_stack_record_summary(
    ...
    let mut session: SummarizeStackSession = {
        let mut init = SummarizeStackSession {
            summary: crate::core_transpiled::alloc::ts_malloc(
    ...
    if !((*head).summary).is_null() {
        ...
        crate::core_transpiled::alloc::ts_free((*head).summary as *mut libc::c_void);
    }
