...
type C2RustUnnamed_3 = crate::core_transpiled::util::StackElement<*mut TSSymbol>;
type C2RustUnnamed_4 = crate::core_transpiled::util::StackElement<*mut libc::c_char>;
type C2RustUnnamed_5 = crate::core_transpiled::util::StackElement<*mut TSFieldId>;
type C2RustUnnamed_6 = crate::core_transpiled::util::StackElement<*mut StepOffset>;
#[derive(Copy, Clone)]
#[repr(C)]
...
type C2RustUnnamed_7 = crate::core_transpiled::util::StackElement<*mut QueryPattern>;
#[derive(Copy, Clone)]
#[repr(C)]
...
type C2RustUnnamed_8 = crate::core_transpiled::util::StackElement<*mut TSQueryPredicateStep>;
#[derive(Copy, Clone)]
#[repr(C)]
...
type C2RustUnnamed_9 = crate::core_transpiled::util::StackElement<*mut PatternEntry>;
#[derive(Copy, Clone)]
#[repr(C)]
...
type C2RustUnnamed_10 = crate::core_transpiled::util::StackElement<*mut QueryStep>;
...
pub struct QueryStep {
    ...
    pub is_named_is_immediate_is_last_child_is_pass_through_is_dead_end_alternative_is_immediate_contains_captures_root_pattern_guaranteed_parent_pattern_guaranteed_is_missing:
        [u8; 2],
}
type C2RustUnnamed_11 = crate::core_transpiled::util::StackElement<*mut CaptureQuantifiers>;
#[derive(Copy, Clone)]
#[repr(C)]
...
type C2RustUnnamed_12 = crate::core_transpiled::util::StackElement<*mut Slice>;
type C2RustUnnamed_13 = crate::core_transpiled::util::StackElement<*mut libc::c_char>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct TSQueryCursor {
    ...
    pub query_options: *const TSQueryCursorOptions,
    pub query_state: TSQueryCursorState,
...
pub struct TSQueryCursorOptions {
    pub payload: *mut libc::c_void,
    pub progress_callback: Option<unsafe extern "C" fn(*mut TSQueryCursorState) -> bool>,
}
...
type C2RustUnnamed_14 = crate::core_transpiled::util::StackElement<*mut CaptureList>;
type C2RustUnnamed_15 = crate::core_transpiled::util::StackElement<*mut QueryState>;
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
...
type C2RustUnnamed_16 = crate::core_transpiled::util::StackElement<*mut QueryState>;
#[derive(Copy, Clone)]
#[repr(C)]
...
type C2RustUnnamed_17 = crate::core_transpiled::util::StackElement<*mut uint16_t>;
type C2RustUnnamed_18 = crate::core_transpiled::util::StackElement<*mut uint32_t>;
type C2RustUnnamed_19 = crate::core_transpiled::util::StackElement<*mut uint16_t>;
type C2RustUnnamed_20 = crate::core_transpiled::util::StackElement<*mut AnalysisSubgraphNode>;
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
...
type C2RustUnnamed_21 = crate::core_transpiled::util::StackElement<*mut TSSymbol>;
type C2RustUnnamed_22 = crate::core_transpiled::util::StackElement<*mut uint16_t>;
#[derive(Copy, Clone)]
#[repr(C)]
...
type C2RustUnnamed_23 = crate::core_transpiled::util::StackElement<*mut AnalysisSubgraphNode>;
type C2RustUnnamed_24 = crate::core_transpiled::util::StackElement<*mut TSStateId>;
...
type C2RustUnnamed_25 = crate::core_transpiled::util::StackElement<*mut uint32_t>;
...
type C2RustUnnamed_26 = crate::core_transpiled::util::ScannerStateWithLookahead;
type C2RustUnnamed_27 = crate::core_transpiled::util::LongShortData;
type C2RustUnnamed_28 = crate::core_transpiled::util::ScannerStateLookaheadMeta;
type C2RustUnnamed_29 = crate::core_transpiled::util::ScannerStateLookaheadFirstLeaf;
type C2RustUnnamed_30 = crate::core_transpiled::util::StackElement<*mut TreeCursorEntry>;
...
unsafe extern "C" fn ts_language_field_map(
    ...
    let mut slice: TSMapSlice = *((*self_0).field_map_slices).offset(production_id as isize);
...
unsafe extern "C" fn ts_language_state_is_primary(
    ...
    if (*self_0).abi_version >= 14 as libc::c_int as libc::c_uint {
...
static mut OP_COUNT_PER_QUERY_TIMEOUT_CHECK: libc::c_uint = 100 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn query_step__new(
    ...
    let mut step: QueryStep = {
        let mut init = QueryStep { is_named_is_immediate_is_last_child_is_pass_through_is_dead_end_alternative_is_immediate_contains_captures_root_pattern_guaranteed_parent_pattern_guaranteed_is_missing : [0 ; 2] , symbol : symbol , supertype_symbol : 0 , field : 0 as libc :: c_int as TSFieldId , capture_ids : [0 ; 3] , depth : depth , alternative_index : NONE , negated_field_list_id : 0 as libc :: c_int as uint16_t , } ;
...
unsafe extern "C" fn state_predecessor_map_new(
    ...
    return {
        let mut init = StatePredecessorMap {
            contents: crate::core_transpiled::alloc::ts_calloc(
...
unsafe extern "C" fn state_predecessor_map_delete(mut self_0: *mut StatePredecessorMap) {
    crate::core_transpiled::alloc::ts_free((*self_0).contents as *mut libc::c_void);
}
#[inline]
...
unsafe extern "C" fn analysis_state_pool__clone_or_reuse(
    ...
    if (*self_0).size != 0 {
        ...
        new_item = crate::core_transpiled::alloc::ts_malloc(
            ::core::mem::size_of::<AnalysisState>() as libc::c_ulong
...
unsafe extern "C" fn analysis_state_set__delete(mut self_0: *mut AnalysisStateSet) {
    let mut i: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    while i < (*self_0).size {
        crate::core_transpiled::alloc::ts_free(
            *((*self_0).contents).offset(i as isize) as *mut libc::c_void
        );
        i = i.wrapping_add(1);
    }
    _array__delete(self_0 as *mut Array);
...
unsafe extern "C" fn ts_query__parse_pattern(
    ...
    if (*stream).next == '[' as i32 {
            ...
            || (*stream).next == '[' as i32
        {
            ...
            let mut is_missing: bool = 0 as libc::c_int != 0;
            ...
            if stream_is_ident_start(stream) {
                ...
                {
                    is_missing = 1 as libc::c_int != 0;
                    stream_skip_whitespace(stream);
                    if stream_is_ident_start(stream) {
                        let mut missing_node_name: *const libc::c_char = (*stream).input;
                        stream_scan_identifier(stream);
                        let mut missing_node_length: uint32_t =
                            ((*stream).input).offset_from(missing_node_name) as libc::c_long
                                as uint32_t;
                        ...
                        let mut string_start: *const libc::c_char = (*stream).input;
                        let mut e_1: TSQueryError = ts_query__parse_string_literal(self_0, stream);
                        if e_1 as u64 != 0 {
                            return e_1;
                        }
                        symbol = ts_language_symbol_for_name(
            ...
            *((*self_0).steps.contents).offset(fresh28 as isize) =
            ...
            if is_missing {
                (*step).set_is_missing(1 as libc::c_int != 0);
            }
            ...
            if (*stream).next == '/' as i32 {
                if (*step).supertype_symbol == 0 {
                    stream_reset(stream, node_name.offset(-(1 as libc::c_int as isize)));
                ...
                let mut subtype_node_name: *const libc::c_char = (*stream).input;
                stream_scan_identifier(stream);
                let mut length_0: uint32_t =
                    ((*stream).input).offset_from(subtype_node_name) as libc::c_long as uint32_t;
                ...
                if (*(*self_0).language).abi_version >= 15 as libc::c_int as libc::c_uint {
                    let mut subtype_length: uint32_t = 0;
                    let mut subtypes: *const TSSymbol = ts_language_subtypes(
                        (*self_0).language,
                        (*step).supertype_symbol,
                        &mut subtype_length,
                    );
                    let mut subtype_is_valid: bool = 0 as libc::c_int != 0;
                    let mut i_0: uint32_t = 0 as libc::c_int as uint32_t;
                    while i_0 < subtype_length {
                        if *subtypes.offset(i_0 as isize) as libc::c_int
                            == (*step).symbol as libc::c_int
                        {
                            subtype_is_valid = 1 as libc::c_int != 0;
                            break;
                        } else {
                            i_0 = i_0.wrapping_add(1);
                        }
            ...
            loop {
                if (*stream).next == '!' as i32 {
                    ...
                    let mut e_2: TSQueryError = ts_query__parse_pattern(
                        self_0,
                        stream,
                    ...
                    if e_2 as libc::c_uint == PARENT_DONE as libc::c_uint {
                        if (*stream).next == ')' as i32 {
                            if child_is_immediate_0 {
                                ...
                                let mut last_child_step: *mut QueryStep =
                                    &mut *((*self_0).steps.contents)
                                        .offset(last_child_step_index as isize)
                                        as *mut QueryStep;
                                (*last_child_step).set_is_last_child(1 as libc::c_int != 0);
                                if (*last_child_step).alternative_index as libc::c_int
                                    != NONE as libc::c_int
                                    && ((*last_child_step).alternative_index as libc::c_uint)
                                        < (*self_0).steps.size
                                {
                                    let mut alternative_step: *mut QueryStep =
                                        &mut *((*self_0).steps.contents)
                                            .offset((*last_child_step).alternative_index as isize)
                                            as *mut QueryStep;
                                    (*alternative_step).set_is_last_child(1 as libc::c_int != 0);
                                    while (*alternative_step).alternative_index as libc::c_int
                                        != NONE as libc::c_int
                                        && ((*alternative_step).alternative_index as libc::c_uint)
                                            < (*self_0).steps.size
                                    {
                                        alternative_step = &mut *((*self_0).steps.contents)
                                            .offset((*alternative_step).alternative_index as isize)
                                            as *mut QueryStep;
                                        (*alternative_step)
                                            .set_is_last_child(1 as libc::c_int != 0);
                                    }
                                }
                            }
        ...
        let fresh29 = (*self_0).steps.size;
        (*self_0).steps.size = ((*self_0).steps.size).wrapping_add(1);
        *((*self_0).steps.contents).offset(fresh29 as isize) =
            query_step__new(WILDCARD_SYMBOL, depth as uint16_t, is_immediate);
    } else if (*stream).next == '"' as i32 {
        let mut string_start_0: *const libc::c_char = (*stream).input;
        let mut e_3: TSQueryError = ts_query__parse_string_literal(self_0, stream);
        if e_3 as u64 != 0 {
            return e_3;
        }
        ...
        if symbol_0 == 0 {
            stream_reset(stream, string_start_0.offset(1 as libc::c_int as isize));
            return TSQueryErrorNodeType;
        }
        _array__grow(
            &mut (*self_0).steps as *mut C2RustUnnamed_10 as *mut Array,
        ...
        *((*self_0).steps.contents).offset(fresh30 as isize) =
        ...
        let mut e_4: TSQueryError = ts_query__parse_pattern(
            self_0,
            stream,
            depth,
            is_immediate,
        ...
        if e_4 as u64 != 0 {
            ...
            if e_4 as libc::c_uint == PARENT_DONE as libc::c_uint {
                e_4 = TSQueryErrorSyntax;
            }
            return e_4;
        }
    ...
    loop {
        if (*stream).next == '+' as i32 {
            ...
            (*self_0).steps.size = ((*self_0).steps.size).wrapping_add(1);
            *((*self_0).steps.contents).offset(fresh31 as isize) = repeat_step;
        } else if (*stream).next == '*' as i32 {
            ...
            (*self_0).steps.size = ((*self_0).steps.size).wrapping_add(1);
            *((*self_0).steps.contents).offset(fresh32 as isize) = repeat_step_0;
...
pub unsafe extern "C" fn ts_query_new(
    ...
    if language.is_null()
        || (*language).abi_version > 15 as libc::c_int as libc::c_uint
        || (*language).abi_version < 13 as libc::c_int as libc::c_uint
    {
        *error_type = TSQueryErrorLanguage;
        return 0 as *mut TSQuery;
    }
    let mut self_0: *mut TSQuery = crate::core_transpiled::alloc::ts_malloc(::core::mem::size_of::<
        TSQuery,
    >()
        as libc::c_ulong) as *mut TSQuery;
    *self_0 = {
    ...
    let fresh33 = (*self_0).negated_fields.size;
    (*self_0).negated_fields.size = ((*self_0).negated_fields.size).wrapping_add(1);
    *((*self_0).negated_fields.contents).offset(fresh33 as isize) = 0 as libc::c_int as TSFieldId;
    ...
    while stream.input < stream.end {
        ...
        let fresh34 = (*self_0).patterns.size;
        (*self_0).patterns.size = ((*self_0).patterns.size).wrapping_add(1);
        *((*self_0).patterns.contents).offset(fresh34 as isize) = {
        ...
        *error_type = ts_query__parse_pattern(
        ...
        let fresh35 = (*self_0).steps.size;
        (*self_0).steps.size = ((*self_0).steps.size).wrapping_add(1);
        *((*self_0).steps.contents).offset(fresh35 as isize) = query_step__new(
            0 as libc::c_int as TSSymbol,
            PATTERN_DONE_MARKER,
            0 as libc::c_int != 0,
        );
        ...
        let fresh36 = (*self_0).capture_quantifiers.size;
        (*self_0).capture_quantifiers.size = ((*self_0).capture_quantifiers.size).wrapping_add(1);
        *((*self_0).capture_quantifiers.contents).offset(fresh36 as isize) = capture_quantifiers;
...
pub unsafe extern "C" fn ts_query_cursor_new() -> *mut TSQueryCursor {
    let mut self_0: *mut TSQueryCursor = crate::core_transpiled::alloc::ts_malloc(
        ::core::mem::size_of::<TSQueryCursor>() as libc::c_ulong,
    ...
    *self_0 = {
        let mut init = TSQueryCursor {
            ...
            timeout_duration: 0 as libc::c_int as TSDuration,
            query_options: 0 as *const TSQueryCursorOptions,
            query_state: TSQueryCursorState {
                payload: 0 as *mut libc::c_void,
                current_byte_offset: 0,
            },
            operation_count: 0 as libc::c_int as libc::c_uint,
...
pub unsafe extern "C" fn ts_query_cursor_exec(
    ...
    (*self_0).query_options = 0 as *const TSQueryCursorOptions;
    (*self_0).query_state = {
        let mut init = TSQueryCursorState {
            payload: 0 as *mut libc::c_void,
            current_byte_offset: 0,
        };
        init
...
pub unsafe extern "C" fn ts_query_cursor_exec_with_options(
    ...
    mut query: *const TSQuery,
    mut node: TSNode,
    mut query_options: *const TSQueryCursorOptions,
) {
    ts_query_cursor_exec(self_0, query, node);
    if !query_options.is_null() {
        (*self_0).query_options = query_options;
        (*self_0).query_state = {
            let mut init = TSQueryCursorState {
                    ...
                    || point_lte(ts_node_end_point(node), (*self_0).start_point) as libc::c_int != 0
                {
                            ...
                            && ((*state).pattern_index as libc::c_uint) < *pattern_index
                    {
                        ...
                        if !is_definite.is_null() {
                            *is_definite = (*step).root_pattern_guaranteed() as libc::c_int != 0
                                && !(*step).is_immediate();
...
unsafe extern "C" fn ts_query_cursor__capture(
    ...
    while j < 3 as libc::c_int as libc::c_uint {
        ...
        let fresh37 = (*capture_list).size;
        (*capture_list).size = ((*capture_list).size).wrapping_add(1);
        *((*capture_list).contents).offset(fresh37 as isize) = {
...
unsafe extern "C" fn ts_query_cursor__advance(
    ...
    loop {
        ...
        if (*self_0).operation_count == OP_COUNT_PER_QUERY_TIMEOUT_CHECK {
            (*self_0).operation_count = 0 as libc::c_int as libc::c_uint;
        }
        if !((*self_0).query_options).is_null()
            && ((*(*self_0).query_options).progress_callback).is_some()
        {
            (*self_0).query_state.current_byte_offset =
                ts_node_start_byte(ts_tree_cursor_current_node(&mut (*self_0).cursor));
        }
        if did_match as libc::c_int != 0
            || (*self_0).halted as libc::c_int != 0
            || (*self_0).operation_count == 0 as libc::c_int as libc::c_uint
                && (!clock_is_null((*self_0).end_clock)
                    && clock_is_gt(clock_now(), (*self_0).end_clock) as libc::c_int != 0
                    || !((*self_0).query_options).is_null()
                        && ((*(*self_0).query_options).progress_callback).is_some()
                        && ((*(*self_0).query_options).progress_callback)
                            .expect("non-null function pointer")(
                            &mut (*self_0).query_state
                        ) as libc::c_int
                            != 0)
        {
            return did_match;
        ...
        if (*self_0).ascending {
            if (*self_0).on_visible_node {
                ...
                while i < n {
                            ...
                            || (*self_0).depth == 0 as libc::c_int as libc::c_uint)
                    {
                        ...
                        let fresh38 = (*self_0).finished_states.size;
                        (*self_0).finished_states.size =
                            ((*self_0).finished_states.size).wrapping_add(1);
                        *((*self_0).finished_states.contents).offset(fresh38 as isize) = *state_0;
            ...
            let mut start_point: TSPoint = ts_node_start_point(node);
            let mut end_point: TSPoint = ts_node_end_point(node);
            ...
            let mut node_precedes_range: bool = parent_precedes_range as libc::c_int != 0
                || end_byte < (*self_0).start_byte
                || point_lt(end_point, (*self_0).start_point) as libc::c_int != 0
                || !is_empty && end_byte == (*self_0).start_byte
                || !is_empty && point_eq(end_point, (*self_0).start_point) as libc::c_int != 0;
            let mut node_follows_range: bool = parent_follows_range as libc::c_int != 0
                || (start_byte >= (*self_0).end_byte
                    || point_gte(start_point, (*self_0).end_point) as libc::c_int != 0);
            ...
            if (*self_0).on_visible_node {
                ...
                let mut is_missing: bool = ts_node_is_missing(node);
                ...
                while j < (*self_0).states.size {
                        ...
                        != (*self_0).depth)
                    {
                        ...
                        if (*step_2).symbol as libc::c_int == WILDCARD_SYMBOL as libc::c_int {
                            ...
                            node_does_match = symbol as libc::c_int
                                == (*step_2).symbol as libc::c_int
                                && (!(*step_2).is_missing() || is_missing as libc::c_int != 0);
                        }
                        ...
                        if !node_does_match {
                            ...
                            if (*state_1).dead() {
                                ...
                                if (*step_2).symbol as libc::c_int == WILDCARD_SYMBOL as libc::c_int
                                    && !(*step_2).is_named()
                                    && (*next_step).is_immediate() as libc::c_int != 0
                                {
                                    (*state_1).set_seeking_immediate_match(1 as libc::c_int != 0);
                                } else {
                        ...
                        while k_1 < (*self_0).states.size {
                            ...
                            if left_contains_right {
                                    ...
                                    == (*other_state).step_index as libc::c_int
                                {
                                    ...
                                    current_block_178 = 9846950269610550213;
                                } else {
                                    (*other_state)
                                        .set_has_in_progress_alternatives(1 as libc::c_int != 0);
                                    current_block_178 = 7256998052328658819;
                                }
                            } else {
                                current_block_178 = 7256998052328658819;
                            }
                                ...
                                == PATTERN_DONE_MARKER as libc::c_int
                            {
                                if !(*state_2).has_in_progress_alternatives() {
                                    ...
                                    *((*self_0).finished_states.contents)
                                        .offset(fresh39 as isize) = *state_2;
                                    _array__erase(
                                        &mut (*self_0).states as *mut C2RustUnnamed_16
                                            as *mut Array,
                                        ::core::mem::size_of::<QueryState>() as libc::c_ulong,
            ...
            if ts_query_cursor__should_descend(self_0, node_intersects_range) {
                ...
                {
                    2 => {
                        current_block_200 = 1656696749794497430;
                        match current_block_200 {
                            12129440449313205530 => {
                                (*self_0).on_visible_node = 0 as libc::c_int != 0;
                                continue;
                            }
                            _ => {
                    ...
                    1 => {
                        current_block_200 = 12129440449313205530;
                        match current_block_200 {
                            12129440449313205530 => {
                                (*self_0).on_visible_node = 0 as libc::c_int != 0;
                                continue;
...
pub unsafe extern "C" fn ts_query_cursor_next_match(
    ...
    if (*state).id == 4294967295 as libc::c_uint {
        let fresh40 = (*self_0).next_state_id;
...
pub unsafe extern "C" fn ts_query_cursor_next_capture(
    ...
    loop {
        ...
        let mut found_unfinished_state: bool = ts_query_cursor__first_in_progress_capture(
            self_0,
        ...
        if capture_list_pool_is_empty(&mut (*self_0).capture_list_pool) as libc::c_int != 0
            && found_unfinished_state as libc::c_int != 0
        {
            capture_list_pool_release(
                &mut (*self_0).capture_list_pool,
