    ...
    loop {
        ...
        if (*self_0).ascending {
                        ...
                        while k_1 < (*self_0).states.size {
                            ...
                            if left_contains_right {
                                    ...
                                    == (*other_state).step_index as libc::c_int
                                {
                                    ...
                                    current_block_167 = 145651165234646754;
                                } else {
                                    (*other_state)
                                        .set_has_in_progress_alternatives(1 as libc::c_int != 0);
                                    current_block_167 = 10485226111480991281;
                                }
                            } else {
                                current_block_167 = 10485226111480991281;
                            }
            ...
            if ts_query_cursor__should_descend(self_0, node_intersects_range) {
                ...
                {
                    2 => {
                        current_block_189 = 10043285778187427915;
                        match current_block_189 {
                            17416027944940096235 => {
                                (*self_0).on_visible_node = 0 as libc::c_int != 0;
                                continue;
                            }
                            _ => {
                    ...
                    1 => {
                        current_block_189 = 17416027944940096235;
                        match current_block_189 {
                            17416027944940096235 => {
                                (*self_0).on_visible_node = 0 as libc::c_int != 0;
                                continue;
