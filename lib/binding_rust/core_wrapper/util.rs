...
use crate::core_transpiled::parser::TSClock;
...
pub union ScannerStateWithLookahead {
    ...
    pub external_scanner_state: crate::core_transpiled::ExternalScannerState,
...
macro_rules! snwrite {
    ($string:expr, $size:expr, $($arg:tt)*) => {
        crate::core_transpiled::util::snwrite_runtime($string, $size, ::std::format_args!($($arg)*))
    }
}
